...
export default function Landing() {
  ...
  return (
    <div className="flex md:flex-row flex-col items-center mx-auto gap-8">
      <div className="md:w-2/3 flex flex-col md:items-start items-center md:text-left text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 h-20 md:h-24">
          {text}
          {characterCount < fullText.length && (
            <span className="inline-block w-3 ml-1 bg-black md:h-8 h-6 md:align-middle align-bottom animate-typing"></span>
          )}
        </h2>
        <p className="md:text-lg text-base mb-4 max-w-2xl">
